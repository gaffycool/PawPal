...
import com.app.presentation.feature.details.BreedViewParameterProvider
...
fun NavController.navigateToComparisonView(
    ...
    navigate(
        Screen.Comparison.routeName + "/${Json.encodeToString(firstBreedData)}" + "/${
            Json.encodeToString(
                secondBreedData
            )
        }"
...
class BreedViewParameterProvider : PreviewParameterProvider<ComparisonViewState> {
    override val values = sequenceOf(
        ComparisonViewState(
            firstBreedData = BreedImagesUiModel(
                BreedModel("Affenpinscher", "", false),
            ),
            secondBreedData = BreedImagesUiModel(
